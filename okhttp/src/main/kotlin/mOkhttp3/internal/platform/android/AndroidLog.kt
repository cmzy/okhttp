 ...
 */
package mOkhttp3.internal.platform.android
...
import mOkhttp3.internal.platform.android.AndroidLog.androidLog
...
object AndroidLog {
  ...
  private val knownLoggers = LinkedHashMap<String, String>().apply {
    ...
    this["mOkhttp3.mockwebserver.MockWebServer"] = "okhttp.MockWebServer"
  }.toMap()
