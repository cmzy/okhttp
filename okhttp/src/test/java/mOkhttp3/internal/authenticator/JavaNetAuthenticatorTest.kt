 ...
 */
package mOkhttp3.internal.authenticator
...
import mOkhttp3.FakeDns
import mOkhttp3.Protocol.HTTP_1_1
import mOkhttp3.Protocol.HTTP_2
...
class JavaNetAuthenticatorTest {
  ...
  fun testBasicAuth() {
    ...
    val address = Address(
        ...
        mOkhttp3.Authenticator.NONE, Proxy.NO_PROXY, listOf(HTTP_1_1),
