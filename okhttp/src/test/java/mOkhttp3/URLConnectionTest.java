...
import mOkhttp3.internal.RecordingAuthenticator;
...
import static mOkhttp3.internal.Internal.addHeaderLenient;
import static mOkhttp3.internal.Util.immutableListOf;
import static mOkhttp3.internal.Util.userAgent;
import static mOkhttp3.internal.http.StatusLine.HTTP_PERM_REDIRECT;
import static mOkhttp3.internal.http.StatusLine.HTTP_TEMP_REDIRECT;
...
public final class URLConnectionTest {
  ...
  @Test public void proxyAuthenticateOnConnect() throws Exception {
    ...
    client = client.newBuilder()
        .proxyAuthenticator(mOkhttp3.Authenticator.JAVA_NET_AUTHENTICATOR)
        .proxy(server.toProxyAddress())
        .sslSocketFactory(
            handshakeCertificates.sslSocketFactory(), handshakeCertificates.trustManager())
        .hostnameVerifier(new RecordingHostnameVerifier())
